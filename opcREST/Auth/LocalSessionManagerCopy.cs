...
{
    /// <summary>
    /// Copy of LocalSessionManager
    /// </summary>
    public partial class LSManagerCopy : ISessionManager
    {
        /// <summary>
        ...
        public readonly ConcurrentDictionary<string, SimpleSession> _sessions =
            new ConcurrentDictionary<string, SimpleSession>(EmbedIO.Sessions.Session.KeyComparer);
        ...
        public bool IsSessionCookie(Cookie cookie)
            => cookie.Name.Equals(CookieName, StringComparison.OrdinalIgnoreCase)
             && !cookie.Expired;

        public Cookie BuildSessionCookie(string id)
        {
